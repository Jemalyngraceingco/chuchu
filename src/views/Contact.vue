            ...
            <nav class="header-nav-bar">
                ...
                <ul class="header-nav-lists">
                    <li class="header-nav-list">
                        <a class="header-nav-link header-active" hre="/home">Home</a>
                    </li>
                    <li class="header-nav-list"><a class="header-nav-link" href="/roomsuites">Rooms and Suites</a></li>
                    <li class="header-nav-list"><a class="header-nav-link" href="/facilities">Facilities</a></li>
                    <li class="header-nav-list"><a class="header-nav-link" href="/contactpage">Contact Us</a></li>
            ...
            <div class="main">
                <div class="contact">
                    <div class="contact-form">
                        <form action="#">
                            ...
                            <textarea class="form-control" rows="5" id="comment" placeholder="Message"
                                style="resize: none; width: 100%;" name="message"></textarea>
                    ...
                    <div class="contact-us">
                        ...
                        <span><i style="font-size: 1.5rem;" class="fa fa-map-marker" aria-hidden="true"></i>23, Fola osibo,
                            Lekki&nbsp;phase&nbsp;1</span>
                        ...
                        <span><i style="font-size: 1.5rem;" class="fa fa-envelope-o"
                                aria-hidden="true"></i>Support@starhotels.com</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <nav class="footer-nav">
                ...
                <div class="footer-contact-us">
                    ...
                    <p class="footer-description-detail">
                        <img :src="require('../assets/img/map-pin.svg')">

                        <span>23, Fola Osibo, Lekki Phase 1</span>
                    </p>
                    <p class="footer-description-detail">
                        <img :src="require('../assets/img/phone.svg')"> <span>
                            08185956620</span>
                    </p>
                    <p class="footer-description-detail">
                ...
                <div class="footer-follow-us">
                    ...
                    <ul class="footer-follow-us-lists">
                        <li class="follow-us-list">
                            <a href="">
                                <img :src="require('../assets/img/facebook.svg')"> </a>
                        </li>
                        <li class="follow-us-list">
                            <a href="">
